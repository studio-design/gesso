...
/*
 * Shared rule set consumed by both .php-cs-fixer.dist.php (mainline src/
 * + tests/) and .php-cs-fixer.pest.dist.php (Pest test files, where
 * `static_lambda` is overridden off because Pest forbids static `it(...)`
 * callbacks). Returning a closure (not a bare array) keeps the rules
 * lazy-loaded — the Pest config can mutate the array without affecting
 * the mainline run.
 */
